                      ...
                      {allComments.map(comment => (
                        <CommentItem 
                          ...
                          onDelete={(id) => {
                              ...
                              return {
                                ...
                                pages: old.pages.map((page: any) => ({
                                  ...
                                  data: {
                                    ...
                                    totalElements: Math.max(0, (page.data?.totalElements || 0) - 1)
                                  }
                                }))
                              };
                            });
                            ...
                            if (commentId) {
                              queryClient.setQueryData(['comment-replies', postId, commentId], (old: any) => {
                                if (!old || !old.pages) return old;
                                return {
                                  ...old,
                                  pages: old.pages.map((page: any) => ({
                                ...
                                return {
                                  ...
                                  pages: old.pages.map((page: any) => ({
                                    ...
                                    data: {
                                      ...page.data,
                                      comments: page.data?.comments?.map((c: any) => 
                                        c.id === commentId ? { ...c, replyCount: Math.max(0, (c.replyCount || 0) - 1) } : c
                                      )
                                    }
                                  }))
                                };
                          ...
                          onUpdate={(updatedComment) => {
                            ...
                            queryClient.setQueryData(['post-comments', postId], updateInPages);
                            if (commentId) {
                              queryClient.setQueryData(['comment-replies', postId, commentId], updateInPages);
                            }
