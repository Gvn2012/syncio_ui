...
import { PostHeader } from '../sub/PostHeader/PostHeader';
import { PostContent } from '../sub/PostContent/PostContent';
import { MediaGallery } from '../sub/MediaGallery/MediaGallery';
import { PostActions } from '../sub/PostActions/PostActions';
import { PostReactionsSummary } from '../sub/PostReactionsSummary/PostReactionsSummary';
import './FeedItem.css';
...
export const FeedItem: React.FC<FeedItemProps> = React.memo(({ post, hideComment = false }) => {
